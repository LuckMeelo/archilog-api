...
namespace ArchiLogApi.Migrations
{
    ...
    [Migration("20250124152548_CreateReservation")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ArchiLogApi.Data.Models.Car", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArchiLogApi.Data.Models.Reservation", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ArchiLogApi.Data.Models.Reservation", b =>
                {
                    b.HasOne("ArchiLogApi.Data.Models.Car", "ReservedCar")
                        .WithMany()
                        .HasForeignKey("CarID")
